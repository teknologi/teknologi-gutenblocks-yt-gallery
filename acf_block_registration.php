    ...
    if( function_exists('acf_register_block_type') ) {
        acf_register_block_type(array(
            ...
            'enqueue_assets'     => function (){
                ...
                wp_register_style('dbt-yt-gallery-css', plugin_dir_url( __FILE__ ) . 'css/teknologi-gutenblocks-yt-gallery.css', array('dbt-yt-gallery-lg-css'), '0.0.4', null);
                ...
                wp_register_script('dbt-yt-gallery-js', plugin_dir_url( __FILE__ ) . 'js/teknologi-gutenblocks-yt-gallery.js', array('dbt-yt-gallery-lg-module-thumbnail-js'), '0.0.4', true);
